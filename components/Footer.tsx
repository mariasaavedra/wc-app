      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="">
            ...
            <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">DOWNLOAD</h6>
            <a href="\resources\2021 WCKC Annual Report.pdf" target="_blank">
              <p className="flex items-center justify-center md:justify-start mb-4">
                <svg
                    fill="white"
                    aria-hidden="true"
            ...
            <a href="resources\WeCode_2023_Futures_Program_Schedule.pdf" target="_blank">
              <p className="flex items-center justify-center md:justify-start mb-4">
                <svg
                    fill="white"
                    aria-hidden="true"
