...
export function Button(props: ButtonProps) {
  ...
  const getClasses = () => {
    if (props.size === "medium") {
      return "w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-brand-green cursor-pointer hover:bg-green-700 md:py-4 md:text-lg md:px-10";
    } else if (props.size === "small") {
      return "w-full flex px-4 py-2 items-center justify-center border border-transparent text-base font-small rounded-xl text-white bg-brand-green cursor-pointer hover:bg-green-700 cursor-pointer ";
    }
  };
  return (
    <div
