...
export interface FullCarouselProps extends MaybeParentComponentProps {
  slides: Array<JSX.Element>;
  pagination: Array<pagination>;
}

export default function FullCarousel(props: FullCarouselProps) {
  const [currentIndex, setCurrentIndex] = useState<number>(0);
  const numToDisplay = 3;

  const positions = props.slides.length / numToDisplay;
